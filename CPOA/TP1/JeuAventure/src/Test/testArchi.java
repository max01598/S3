...
public class testArchi {
	...
	@Test
	public void HeritagePersonneChevalier() throws IOException {
	File file = new File("uml.txt");
	BufferedReader reader = new BufferedReader(new FileReader(file));
	String line= null;
	...
	@Test
	public void ComportementArmeInterface() throws IOException {
		File file = new File("uml.txt");
		BufferedReader reader = new BufferedReader(new FileReader(file));
		String line= null;
		boolean trouve=false;
		while((line=reader.readLine())!=null)
		{
			if(line.contains("interface ComportementArme"))
			{
				trouve=true;
			}
		}
